...
public class DoblementeEnlazada {
    ...
    public boolean insertAfter(int targetData, int newData) {
        Nodo current = head;
        while (current != null) {
            if (current.data == targetData) {
                ...
                if (current.next != null) {
                    ...
                    tail = newNode; // Actualizar tail si se inserta al final
                }
    ...
    public void reverse() {
        Nodo current = head;
        Nodo temp = null;
        // Intercambiar next y prev para todos los nodos
        while (current != null) {
            temp = current.prev;
            current.prev = current.next;
            current.next = temp;
            current = current.prev; // Moverse al siguiente nodo (que ahora es prev)
        }
